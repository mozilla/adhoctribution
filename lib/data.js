  ...
  pool.getConnection(function (err, connection) {
    if (err) {
      ...
      var query = 'SELECT \
              ...
              (SELECT COUNT(DISTINCT contributor_id) FROM contributions WHERE mofo_team LIKE "moco-%") AS moco_contributors, \
              (SELECT COUNT(*) FROM contributions WHERE mofo_team LIKE "moco-%") AS moco_contributions, \
              (SELECT COUNT(DISTINCT contributor_id) FROM contributions WHERE mofo_team LIKE "mofo-%") AS mofo_contributors, \
              (SELECT COUNT(*) FROM contributions WHERE mofo_team LIKE "mofo-%") AS mofo_contributions';
